...
//}, 100);
  ...
  //tentativa baxiod de corrig ra tela pro teclado $ cope.s
  
    //tentativa abaixo de corrigir a tela pro teclado
 ...
 //   $scope.$on( '$ionicView.beforeLeave', function () {
  //    if ( window.cordova && window.cordova.plugins.Keyboard ) {
   ...
   // });
    //fim tentativa
    //comandos abaixos fazem a verificação se é android ou IoS
   // $ionicPlatform.is(ios)
...
$stateProvider.state('NovoEnderecoCliente', {
  cache: false,
  url: '/NovoEnderecoCliente',
  templateUrl: 'templates/NovoEnderecoCliente.html',
 // controller: 'VisualizarOfertaCtrl'
});
